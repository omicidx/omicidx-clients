...
// BiosampleByAccessionBiosampleSamplesAccessionGetOpts Optional parameters for the method 'BiosampleByAccessionBiosampleSamplesAccessionGet'
type BiosampleByAccessionBiosampleSamplesAccessionGetOpts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
}

/*
BiosampleByAccessionBiosampleSamplesAccessionGet Biosample By Accession
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *BiosampleByAccessionBiosampleSamplesAccessionGetOpts - Optional Parameters:
...
*/
func (a *BiosampleApiService) BiosampleByAccessionBiosampleSamplesAccessionGet(ctx _context.Context, accession string, localVarOptionals *BiosampleByAccessionBiosampleSamplesAccessionGetOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
// BiosampleByAccessionBiosampleSamplesAccessionGet_1Opts Optional parameters for the method 'BiosampleByAccessionBiosampleSamplesAccessionGet_1'
type BiosampleByAccessionBiosampleSamplesAccessionGet_1Opts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
}

/*
BiosampleByAccessionBiosampleSamplesAccessionGet_0 Biosample By Accession
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *BiosampleByAccessionBiosampleSamplesAccessionGet_1Opts - Optional Parameters:
 * @param "IncludeFields" (optional.Interface of []string) -  Fields to include in results. The default is to all fields (*)
 * @param "ExcludeFields" (optional.Interface of []string) -  Fields to exclude from results. The default is to not exclude any fields. 
@return map[string]interface{}
*/
func (a *BiosampleApiService) BiosampleByAccessionBiosampleSamplesAccessionGet_1(ctx _context.Context, accession string, localVarOptionals *BiosampleByAccessionBiosampleSamplesAccessionGet_1Opts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// BiosamplesBiosampleSamplesGetOpts Optional parameters for the method 'BiosamplesBiosampleSamplesGet'
type BiosamplesBiosampleSamplesGetOpts struct {
    Q optional.String
    Size optional.Int32
...
/*
BiosamplesBiosampleSamplesGet Biosamples
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BiosamplesBiosampleSamplesGetOpts - Optional Parameters:
...
*/
func (a *BiosampleApiService) BiosamplesBiosampleSamplesGet(ctx _context.Context, localVarOptionals *BiosamplesBiosampleSamplesGetOpts) (ResponseModel, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// BiosamplesBiosampleSamplesGet_2Opts Optional parameters for the method 'BiosamplesBiosampleSamplesGet_2'
type BiosamplesBiosampleSamplesGet_2Opts struct {
    Q optional.String
    Size optional.Int32
    Cursor optional.String
    FacetSize optional.Int32
...
/*
BiosamplesBiosampleSamplesGet_0 Biosamples
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BiosamplesBiosampleSamplesGet_2Opts - Optional Parameters:
 * @param "Q" (optional.String) -  The query, using [lucene query syntax](https://lucene.apache.org/core/3_6_0/queryparsersyntax.html)
 * @param "Size" (optional.Int32) - 
 * @param "Cursor" (optional.String) -  The cursor is used to scroll through results. For a query with more results than `size`, the result will include `cursor` in the result json. Use that value here and re-issue the query. The next set or results will be returned. When no more results are available, the `cursor` will again be empty in the result json.
 * @param "FacetSize" (optional.Int32) -  The maximum number of records returned for each facet. This has no effect unless one or more facets are specified.
...
@return ResponseModel
*/
func (a *BiosampleApiService) BiosamplesBiosampleSamplesGet_2(ctx _context.Context, localVarOptionals *BiosamplesBiosampleSamplesGet_2Opts) (ResponseModel, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
MappingBiosampleFieldsEntityGet Mapping
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param entity
@return map[string]interface{}
*/
func (a *BiosampleApiService) MappingBiosampleFieldsEntityGet(ctx _context.Context, entity string) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
