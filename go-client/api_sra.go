...
// ByAccessionSraExperimentsAccessionGet_1Opts Optional parameters for the method 'ByAccessionSraExperimentsAccessionGet_1'
type ByAccessionSraExperimentsAccessionGet_1Opts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
}

/*
ByAccessionSraExperimentsAccessionGet_0 Experiment By Accession
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *ByAccessionSraExperimentsAccessionGet_1Opts - Optional Parameters:
 * @param "IncludeFields" (optional.Interface of []string) -  Fields to include in results. The default is to all fields (*)
 * @param "ExcludeFields" (optional.Interface of []string) -  Fields to exclude from results. The default is to not exclude any fields. 
@return map[string]interface{}
*/
func (a *SRAApiService) ByAccessionSraExperimentsAccessionGet_1(ctx _context.Context, accession string, localVarOptionals *ByAccessionSraExperimentsAccessionGet_1Opts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ByAccessionSraRunsAccessionGet_2Opts Optional parameters for the method 'ByAccessionSraRunsAccessionGet_2'
type ByAccessionSraRunsAccessionGet_2Opts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
}

/*
ByAccessionSraRunsAccessionGet_0 Run By Accession
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *ByAccessionSraRunsAccessionGet_2Opts - Optional Parameters:
 * @param "IncludeFields" (optional.Interface of []string) -  Fields to include in results. The default is to all fields (*)
 * @param "ExcludeFields" (optional.Interface of []string) -  Fields to exclude from results. The default is to not exclude any fields. 
@return map[string]interface{}
*/
func (a *SRAApiService) ByAccessionSraRunsAccessionGet_2(ctx _context.Context, accession string, localVarOptionals *ByAccessionSraRunsAccessionGet_2Opts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ByAccessionSraSamplesAccessionGet_3Opts Optional parameters for the method 'ByAccessionSraSamplesAccessionGet_3'
type ByAccessionSraSamplesAccessionGet_3Opts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
}

/*
ByAccessionSraSamplesAccessionGet_0 Sample By Accession
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *ByAccessionSraSamplesAccessionGet_3Opts - Optional Parameters:
 * @param "IncludeFields" (optional.Interface of []string) -  Fields to include in results. The default is to all fields (*)
 * @param "ExcludeFields" (optional.Interface of []string) -  Fields to exclude from results. The default is to not exclude any fields. 
@return map[string]interface{}
*/
func (a *SRAApiService) ByAccessionSraSamplesAccessionGet_3(ctx _context.Context, accession string, localVarOptionals *ByAccessionSraSamplesAccessionGet_3Opts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ByAccessionSraStudiesAccessionGet_4Opts Optional parameters for the method 'ByAccessionSraStudiesAccessionGet_4'
type ByAccessionSraStudiesAccessionGet_4Opts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
}

/*
ByAccessionSraStudiesAccessionGet_0 Study By Accession
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *ByAccessionSraStudiesAccessionGet_4Opts - Optional Parameters:
 * @param "IncludeFields" (optional.Interface of []string) -  Fields to include in results. The default is to all fields (*)
 * @param "ExcludeFields" (optional.Interface of []string) -  Fields to exclude from results. The default is to not exclude any fields. 
@return map[string]interface{}
*/
func (a *SRAApiService) ByAccessionSraStudiesAccessionGet_4(ctx _context.Context, accession string, localVarOptionals *ByAccessionSraStudiesAccessionGet_4Opts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ForExperimentSraExperimentsAccessionRunsGet_5Opts Optional parameters for the method 'ForExperimentSraExperimentsAccessionRunsGet_5'
type ForExperimentSraExperimentsAccessionRunsGet_5Opts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
    Size optional.Int32
    Cursor optional.String
...
/*
ForExperimentSraExperimentsAccessionRunsGet_0 Runs For Experiment
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *ForExperimentSraExperimentsAccessionRunsGet_5Opts - Optional Parameters:
 * @param "IncludeFields" (optional.Interface of []string) -  Fields to include in results. The default is to all fields (*)
 * @param "ExcludeFields" (optional.Interface of []string) -  Fields to exclude from results. The default is to not exclude any fields. 
 * @param "Size" (optional.Int32) - 
 * @param "Cursor" (optional.String) - 
@return map[string]interface{}
*/
func (a *SRAApiService) ForExperimentSraExperimentsAccessionRunsGet_5(ctx _context.Context, accession string, localVarOptionals *ForExperimentSraExperimentsAccessionRunsGet_5Opts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ForSampleSraSamplesAccessionExperimentsGet_6Opts Optional parameters for the method 'ForSampleSraSamplesAccessionExperimentsGet_6'
type ForSampleSraSamplesAccessionExperimentsGet_6Opts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
    Size optional.Int32
    Cursor optional.String
...
/*
ForSampleSraSamplesAccessionExperimentsGet_0 Experiments For Sample
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *ForSampleSraSamplesAccessionExperimentsGet_6Opts - Optional Parameters:
 * @param "IncludeFields" (optional.Interface of []string) -  Fields to include in results. The default is to all fields (*)
 * @param "ExcludeFields" (optional.Interface of []string) -  Fields to exclude from results. The default is to not exclude any fields. 
 * @param "Size" (optional.Int32) - 
 * @param "Cursor" (optional.String) - 
@return map[string]interface{}
*/
func (a *SRAApiService) ForSampleSraSamplesAccessionExperimentsGet_6(ctx _context.Context, accession string, localVarOptionals *ForSampleSraSamplesAccessionExperimentsGet_6Opts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ForSampleSraSamplesAccessionRunsGet_7Opts Optional parameters for the method 'ForSampleSraSamplesAccessionRunsGet_7'
type ForSampleSraSamplesAccessionRunsGet_7Opts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
    Size optional.Int32
    Cursor optional.String
...
/*
ForSampleSraSamplesAccessionRunsGet_0 Runs For Sample
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *ForSampleSraSamplesAccessionRunsGet_7Opts - Optional Parameters:
 * @param "IncludeFields" (optional.Interface of []string) -  Fields to include in results. The default is to all fields (*)
 * @param "ExcludeFields" (optional.Interface of []string) -  Fields to exclude from results. The default is to not exclude any fields. 
 * @param "Size" (optional.Int32) - 
 * @param "Cursor" (optional.String) - 
@return map[string]interface{}
*/
func (a *SRAApiService) ForSampleSraSamplesAccessionRunsGet_7(ctx _context.Context, accession string, localVarOptionals *ForSampleSraSamplesAccessionRunsGet_7Opts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ForStudySraStudiesAccessionExperimentsGet_8Opts Optional parameters for the method 'ForStudySraStudiesAccessionExperimentsGet_8'
type ForStudySraStudiesAccessionExperimentsGet_8Opts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
    Size optional.Int32
    Cursor optional.String
...
/*
ForStudySraStudiesAccessionExperimentsGet_0 Experiments For Study
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *ForStudySraStudiesAccessionExperimentsGet_8Opts - Optional Parameters:
 * @param "IncludeFields" (optional.Interface of []string) -  Fields to include in results. The default is to all fields (*)
 * @param "ExcludeFields" (optional.Interface of []string) -  Fields to exclude from results. The default is to not exclude any fields. 
 * @param "Size" (optional.Int32) - 
 * @param "Cursor" (optional.String) - 
@return map[string]interface{}
*/
func (a *SRAApiService) ForStudySraStudiesAccessionExperimentsGet_8(ctx _context.Context, accession string, localVarOptionals *ForStudySraStudiesAccessionExperimentsGet_8Opts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ForStudySraStudiesAccessionRunsGet_9Opts Optional parameters for the method 'ForStudySraStudiesAccessionRunsGet_9'
type ForStudySraStudiesAccessionRunsGet_9Opts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
    Size optional.Int32
    Cursor optional.String
...
/*
ForStudySraStudiesAccessionRunsGet_0 Runs For Study
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *ForStudySraStudiesAccessionRunsGet_9Opts - Optional Parameters:
 * @param "IncludeFields" (optional.Interface of []string) -  Fields to include in results. The default is to all fields (*)
 * @param "ExcludeFields" (optional.Interface of []string) -  Fields to exclude from results. The default is to not exclude any fields. 
 * @param "Size" (optional.Int32) - 
 * @param "Cursor" (optional.String) - 
@return map[string]interface{}
*/
func (a *SRAApiService) ForStudySraStudiesAccessionRunsGet_9(ctx _context.Context, accession string, localVarOptionals *ForStudySraStudiesAccessionRunsGet_9Opts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ForStudySraStudiesAccessionSamplesGet_10Opts Optional parameters for the method 'ForStudySraStudiesAccessionSamplesGet_10'
type ForStudySraStudiesAccessionSamplesGet_10Opts struct {
    IncludeFields optional.Interface
    ExcludeFields optional.Interface
    Size optional.Int32
    Cursor optional.String
...
/*
ForStudySraStudiesAccessionSamplesGet_0 Samples For Study
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accession An accession for lookup
 * @param optional nil or *ForStudySraStudiesAccessionSamplesGet_10Opts - Optional Parameters:
 * @param "IncludeFields" (optional.Interface of []string) -  Fields to include in results. The default is to all fields (*)
 * @param "ExcludeFields" (optional.Interface of []string) -  Fields to exclude from results. The default is to not exclude any fields. 
 * @param "Size" (optional.Int32) - 
 * @param "Cursor" (optional.String) - 
@return map[string]interface{}
*/
func (a *SRAApiService) ForStudySraStudiesAccessionSamplesGet_10(ctx _context.Context, accession string, localVarOptionals *ForStudySraStudiesAccessionSamplesGet_10Opts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// SraExperimentsGet_11Opts Optional parameters for the method 'SraExperimentsGet_11'
type SraExperimentsGet_11Opts struct {
    Q optional.String
    Size optional.Int32
    Cursor optional.String
    FacetSize optional.Int32
...
/*
SraExperimentsGet_0 Experiments
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SraExperimentsGet_11Opts - Optional Parameters:
 * @param "Q" (optional.String) -  The query, using [lucene query syntax](https://lucene.apache.org/core/3_6_0/queryparsersyntax.html)
 * @param "Size" (optional.Int32) - 
 * @param "Cursor" (optional.String) -  The cursor is used to scroll through results. For a query with more results than `size`, the result will include `cursor` in the result json. Use that value here and re-issue the query. The next set or results will be returned. When no more results are available, the `cursor` will again be empty in the result json.
 * @param "FacetSize" (optional.Int32) -  The maximum number of records returned for each facet. This has no effect unless one or more facets are specified.
...
@return ResponseModel
*/
func (a *SRAApiService) SraExperimentsGet_11(ctx _context.Context, localVarOptionals *SraExperimentsGet_11Opts) (ResponseModel, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// SraRunsGet_12Opts Optional parameters for the method 'SraRunsGet_12'
type SraRunsGet_12Opts struct {
    Q optional.String
    Size optional.Int32
    Cursor optional.String
    FacetSize optional.Int32
...
SraRunsGet_0 Runs
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SraRunsGet_12Opts - Optional Parameters:
 * @param "Q" (optional.String) -  The query, using [lucene query syntax](https://lucene.apache.org/core/3_6_0/queryparsersyntax.html)
 * @param "Size" (optional.Int32) - 
 * @param "Cursor" (optional.String) -  The cursor is used to scroll through results. For a query with more results than `size`, the result will include `cursor` in the result json. Use that value here and re-issue the query. The next set or results will be returned. When no more results are available, the `cursor` will again be empty in the result json.
 * @param "FacetSize" (optional.Int32) -  The maximum number of records returned for each facet. This has no effect unless one or more facets are specified.
...
@return ResponseModel
*/
func (a *SRAApiService) SraRunsGet_12(ctx _context.Context, localVarOptionals *SraRunsGet_12Opts) (ResponseModel, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// SraSamplesGet_13Opts Optional parameters for the method 'SraSamplesGet_13'
type SraSamplesGet_13Opts struct {
    Q optional.String
    Size optional.Int32
    Cursor optional.String
    FacetSize optional.Int32
...
/*
SraSamplesGet_0 Samples
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SraSamplesGet_13Opts - Optional Parameters:
 * @param "Q" (optional.String) -  The query, using [lucene query syntax](https://lucene.apache.org/core/3_6_0/queryparsersyntax.html)
 * @param "Size" (optional.Int32) - 
 * @param "Cursor" (optional.String) -  The cursor is used to scroll through results. For a query with more results than `size`, the result will include `cursor` in the result json. Use that value here and re-issue the query. The next set or results will be returned. When no more results are available, the `cursor` will again be empty in the result json.
 * @param "FacetSize" (optional.Int32) -  The maximum number of records returned for each facet. This has no effect unless one or more facets are specified.
...
@return ResponseModel
*/
func (a *SRAApiService) SraSamplesGet_13(ctx _context.Context, localVarOptionals *SraSamplesGet_13Opts) (ResponseModel, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// SraStudiesGet_14Opts Optional parameters for the method 'SraStudiesGet_14'
type SraStudiesGet_14Opts struct {
    Q optional.String
    Size optional.Int32
    Cursor optional.String
    FacetSize optional.Int32
...
/*
SraStudiesGet_0 Studies
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SraStudiesGet_14Opts - Optional Parameters:
 * @param "Q" (optional.String) -  The query, using [lucene query syntax](https://lucene.apache.org/core/3_6_0/queryparsersyntax.html)
 * @param "Size" (optional.Int32) - 
 * @param "Cursor" (optional.String) -  The cursor is used to scroll through results. For a query with more results than `size`, the result will include `cursor` in the result json. Use that value here and re-issue the query. The next set or results will be returned. When no more results are available, the `cursor` will again be empty in the result json.
 * @param "FacetSize" (optional.Int32) -  The maximum number of records returned for each facet. This has no effect unless one or more facets are specified.
...
@return ResponseModel
*/
func (a *SRAApiService) SraStudiesGet_14(ctx _context.Context, localVarOptionals *SraStudiesGet_14Opts) (ResponseModel, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
